	...
	<MkSpacer :marginMin="20" :marginMax="28">
		<div class="_gaps_m">
			...
			<MkFolder :defaultOpen="true">
				...
				<a href="https://lapy.notion.site/Misskey-f44c9d69728b46ada0eadc2b55b893f6" class="_link" target="_blank">{{ i18n.ts.basicNotesBeforeCreateAccount }} <i class="ti ti-external-link"></i></a>
